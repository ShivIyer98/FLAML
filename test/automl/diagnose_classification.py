...
def test_simple(method=None):
    ...
    #automl.diagnose(class_names={0: 'class_0', 1:'class_1', 2: 'class_2'}, problem_type="classification", level=1)
    automl.diagnose(explainer = "SHAP", problem_type="classification", level=1)
